...
class Player:
    lvl = 1  # Уровень игрока (максимум 10)
    bonus = 0  # Чтобы получить бонус, нужно надеть снаряжение
    power = lvl + bonus # Сила игрока - это уровень + его суммарные бонусы
    items = []  # Снаряжение игрока
    gold = 1000  # Золото игрока (валюта)
    type = 'human'  # Класс игрока, изначально все люди, но могут поменять его на эльфа, воина или вора
